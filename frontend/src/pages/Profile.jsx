                 ...
                 <div className="relative w-full max-w-xs">
                  ...
                  <div className="relative p-8 flex flex-col items-center justify-center">
                    <p className="text-[10px] text-cyan-400/60 uppercase tracking-[0.3em] font-black mb-4">Body Mass Index</p>
                      ...
                      {/* Status Badge */}
                      <div className="px-4 py-2 rounded-lg border backdrop-blur-sm" style={{ borderColor: `${bmiState.color}60`, backgroundColor: `${bmiState.color}08`, boxShadow: `0 0 40px ${bmiState.color}40, inset 0 0 20px ${bmiState.color}15` }}>
