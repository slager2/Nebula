...
function getSyncColor(rate) {
  if (rate >= 80) return '#22d3ee';
  if (rate >= 50) return '#a78bfa';
  return '#f87171';
}
    ...
    <div className="h-full p-8 flex flex-col gap-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 flex-1 min-h-0">
        ...
        <div className="lg:col-span-3 bg-[#0B0C10]/80 backdrop-blur-xl border border-white/5 rounded-2xl p-8 flex flex-col relative overflow-hidden shadow-2xl"
             style={{ boxShadow: '0 35px 70px -15px rgba(6,182,212,0.25), inset 0 0 120px rgba(6,182,212,0.12)' }}>
          
          <div className="absolute inset-0 opacity-30 pointer-events-none" style={{ backgroundImage: 'linear-gradient(rgba(6,182,212,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(6,182,212,0.1)_1px,transparent_1px)', backgroundSize: '50px 50px' }} />
          
          <div className="absolute top-0 left-0 w-32 h-32 bg-gradient-to-br from-cyan-500/8 to-transparent pointer-events-none" />
          <div className="absolute bottom-0 right-0 w-32 h-32 bg-gradient-to-tl from-cyan-500/8 to-transparent pointer-events-none" />
          ...
          <div className="flex-1 relative z-10 w-full flex flex-col">
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-gradient-to-br from-cyan-500/12 to-transparent border border-cyan-500/45 rounded-xl p-4 backdrop-blur-sm hover:border-cyan-500/50 transition-all"
                   style={{ boxShadow: '0 0 30px rgba(6,182,212,0.15), inset 0 0 30px rgba(6,182,212,0.08)' }}>
                ...
                <input
                  ...
                  className="w-full bg-black/50 text-2xl font-black font-mono text-cyan-300 border border-cyan-500/25 rounded-lg px-4 py-3 focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-500/80 transition-all text-center placeholder-cyan-900/80 backdrop-blur-sm"
            ...
            <div className="relative flex-1 flex items-center justify-center">
              <div className="scanner-line absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-transparent via-cyan-200 to-transparent" 
                   style={{ boxShadow: '0 0 30px rgba(6,182,212,1), 0 0 60px rgba(6,182,212,0.6)' }} />

              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative w-full max-w-xs">
                  <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/8 via-transparent to-cyan-500/8 rounded-2xl border border-cyan-500/20 backdrop-blur-md"
                       style={{ boxShadow: '0 0 60px rgba(6,182,212,0.25), inset 0 0 60px rgba(6,182,212,0.12)' }} />
                  ...
                  <div className="relative p-8 flex flex-col items-center justify-center">
                    ...
                    <div className="relative mb-6">
                      <p className="text-6xl font-black font-mono" style={{ color: bmiState.color, textShadow: `0 0 50px ${bmiState.color}, 0 0 100px ${bmiState.color}60` }}>
                        {bmi > 0 ? bmi.toFixed(1) : '—'}
                      </p>
                    </div>

                    <div className="px-4 py-2 rounded-lg border backdrop-blur-sm" style={{ borderColor: `${bmiState.color}50`, backgroundColor: `${bmiState.color}08`, boxShadow: `0 0 40px ${bmiState.color}40, inset 0 0 20px ${bmiState.color}15` }}>
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-8 w-full text-center">
                      <div className="bg-cyan-500/8 border border-cyan-500/35 rounded-lg p-3 backdrop-blur-sm" style={{ boxShadow: 'inset 0 0 20px rgba(6,182,212,0.10)' }}>
          ...
          <div className="relative z-10 mt-6">
            <button
              onClick={handleSave}
              disabled={saving}
              className="w-full bg-gradient-to-r from-cyan-500/30 to-cyan-500/15 hover:from-cyan-500/40 hover:to-cyan-500/25 text-cyan-300 border border-cyan-500/50 rounded-xl py-4 text-xs tracking-[0.2em] font-black uppercase transition-all duration-300 disabled:opacity-50 flex items-center justify-center gap-3 backdrop-blur-sm hover:shadow-[0_0_50px_rgba(6,182,212,0.45)]"
              style={{ boxShadow: '0 0 40px rgba(6,182,212,0.30)' }}
            >
              {saving ? (
                <>
